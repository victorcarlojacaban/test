...
<body>
	<div class="container">
		...
		<div class="jumbotron">
		  ...
		  <p class="lead">1. Assign pop to query param like. <b>domain/test/test1.php?pop=yes</b></p>
		  <p class="lead">2. Assign img to query param like. <b>domain/test/test1.php?img=1</b></p>
